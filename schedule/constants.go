...
const MachineALoop = 4096 //实例调度迭代次数A
const MachineBLoop = 4096 //实例调度迭代次数B
const MachineCLoop = 8192 //实例调度迭代次数C
const MachineDLoop = 8192 //实例调度迭代次数D
