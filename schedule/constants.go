...
const MachineCLoop = 32768      //实例调度迭代次数C，可以统一为16384或更高
const MachineDLoop = 32768      //实例调度迭代次数D，可以统一为16384或更高
const MachineELoop = 32768 * 32 //数据E没有Job，无限迭代
